...
<script language="javascript">				
	...
	{				
		...
		window.location ="index.php?com=product&act=<?php if($_REQUEST['act']=='edit_item') echo 'edit_item'; else echo 'add_item';?><?php if($_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?>&type=<?=$type?>&id_danhmuc="+b.value;	
		return true;
	}
	...
	{				
		...
		window.location ="index.php?com=product&act=<?php if($_REQUEST['act']=='edit_item') echo 'edit_item'; else echo 'add_item';?><?php if($_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?>&type=<?=$type?>&id_danhmuc="+a.value+"&id_list="+b.value;	
		return true;
	}
...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="index.php?com=product&act=man_item<?php if($type!='') echo'&type='. $type;?>"><span>Danh mục</span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=product&act=save_item<?php if($p!='') echo'&p='.$p;?><?php if($type!='') echo'&type='. $type;?>" method="post" enctype="multipart/form-data">
 	...
 	<div class="formRow">
        ...
        <div class="formRow">
            <div class="formRight">
                ...
                <a href="index.php?com=product&act=man_item<?php if($p!='') echo'&p='.$p;?><?php if($type!='') echo'&type='.$type;?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
            </div>
            <div class="clear"></div>
        </div>
