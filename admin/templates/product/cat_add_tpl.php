...
<script language="javascript">				
	...
	{				
		...
		window.location ="index.php?com=product&act=<?php if($_REQUEST['act']=='edit_cat') echo 'edit_cat'; else echo 'add_cat';?><?php if($id!='') echo"&id=".$id; ?>&type=<?=$type?>&id_danhmuc="+a.value;	
		return true;
	}
	...
	{				
		...
		window.location ="index.php?com=product&act=<?php if($_REQUEST['act']=='edit_cat') echo 'edit_cat'; else echo 'add_cat';?><?php if($id!='') echo"&id=".$id; ?>&type=<?=$type?>&id_danhmuc="+a.value+"&id_list="+b.value;	
		return true;
	}	
</script>
