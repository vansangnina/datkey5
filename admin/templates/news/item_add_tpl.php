...
<script language="javascript">	
	...
	{				
		...
		window.location ="index.php?com=news&act=<?php if($_REQUEST['act']=='edit') echo 'edit'; else echo 'add';?><?php if($id!='') echo"&id=".$id; ?><?php if($type!='') echo"&type=".$type; ?>&id_danhmuc="+a.value;	
		return true;
	}
	...
	{				
		...
		window.location ="index.php?com=news&act=<?php if($_REQUEST['act']=='edit') echo 'edit'; else echo 'add';?><?php if($id!='') echo"&id=".$id; ?><?php if($type!='') echo"&type=".$type; ?>&id_danhmuc="+a.value+"&id_list="+b.value;	
		return true;
	}
	...
	{				
		...
		window.location ="index.php?com=news&act=<?php if($_REQUEST['act']=='edit') echo 'edit'; else echo 'add';?><?php if($id!='') echo"&id=".$id; ?><?php if($type!='') echo"&type=".$type; ?>&id_danhmuc="+a.value+"&id_list="+b.value+"&id_cat="+c.value;	
		return true;
	}	
