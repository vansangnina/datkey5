...
<script language="javascript">				
	...
	{				
		...
		window.location ="index.php?com=news&act=<?php if($_REQUEST['act']=='edit_item') echo 'edit_item'; else echo 'add_item';?><?php if($id!='') echo"&id=".$id; ?>&type=<?=$type?>&id_danhmuc="+b.value;	
		return true;
	}
	...
	{				
		...
		window.location ="index.php?com=news&act=<?php if($_REQUEST['act']=='edit_item') echo 'edit_item'; else echo 'add_item';?><?php if($id!='') echo"&id=".$id; ?>&type=<?=$type?>&id_danhmuc="+a.value+"&id_list="+b.value;	
		return true;
	}
