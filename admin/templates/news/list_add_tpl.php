...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="index.php?com=news&act=man_list<?php if($type!='') echo'&type='. $type;?>"><span>Danh mục</span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=news&act=save_list<?php if($p!='') echo'&p='.$p;?><?php if($type!='') echo'&type='. $type;?>" method="post" enctype="multipart/form-data">
 	...
 	<div class="formRow">
        ...
        <div class="formRow">
            <div class="formRight">
                ...
                <a href="index.php?com=news&act=man_list<?php if($p!='') echo'&p='.$p;?><?php if($type!='') echo'&type='.$type;?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
            </div>
            <div class="clear"></div>
        </div>
