...
<form name="supplier" id="validate" class="form" action="index.php?com=slider&act=save_photo&id=<?=$id;?><?php if($id_slider!='') echo'&id_slider='. $id_slider;?><?php if($type!='') echo'&type='. $type;?><?php if($p!='') echo'&p='.$p;?>" method="post" enctype="multipart/form-data">
	<div class="widget">
