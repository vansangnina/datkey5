...
<table class="blue_table">
	...
	<tr bgcolor="<?php if($i%2==1)echo '#F3F3F3' ?>">
		...
		<td style="width:6%;">
            ...
            <a href="index.php?com=hinhthucgiaohang&act=man<?php if($p!='') echo'&id_item='. $p;?>&hienthi=<?=$items[$i]['id']?><?php if($p!='') echo'&curPage='. $p;?>"><img src="media/images/active_1.png"  border="0"/></a>
            <? } else { ?>
            <a href="index.php?com=hinhthucgiaohang&act=man<?php if($p!='') echo'&id_item='. $p;?>&hienthi=<?=$items[$i]['id']?><?php if($p!='') echo'&curPage='. $p;?>"><img src="media/images/active_0.png" border="0" /></a>
            <?php } ?>        
        </td>
