...
<form name="supplier" id="validate" class="form" action="index.php?com=video&act=save<?php if($curPage!='') echo'&curPage='.$curPage;?>&type=<?=$type?>" method="post" enctype="multipart/form-data">
